...
<div class="container mt-5">
    <h3>Ejercicio 6 - Datos Personales + Deportes</h3>
    <form action="../../../accion/TP1/ej6/formAccion.php" method="post" class="p-3 border rounded bg-light shadow-sm">
        ...
        <div class="mb-3">
            <label class="form-label">Deportes que practica:</label><br>
